...
type Function struct {
	...
	StorageAccount string `json:"storage_account,omitempty" yaml:"storage_account,omitempty" mapstructure:"storage_account,omitempty" validate:"required_if=Cloud azure,excluded_with=S3 GoogleStorage"`
	S3             string `json:"s3,omitempty" yaml:"s3,omitempty" mapstructure:"s3,omitempty" validate:"required_if=Cloud aws,excluded_with=StorageAccount GoogleStorage"`
	GoogleStorage  string `json:"google_storage,omitempty" yaml:"google_storage,omitempty" mapstructure:"google_storage,omitempty" validate:"required_if=Cloud gcp,excluded_with=StorageAccount S3"`
	...
	Cdn *Cdn `json:"cdn,omitempty" yaml:"cdn,omitempty" mapstructure:"cdn,omitempty" validate:"dive,omitempty"`

	Database *Database `json:"db,omitempty" yaml:"db,omitempty" mapstructure:"db,omitempty" validate:"dive,omitempty"`
}
